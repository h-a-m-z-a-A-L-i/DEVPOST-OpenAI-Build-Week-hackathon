...
- The runtime uses a `60 / 28`-second minimum request interval, staying at or below 28 RPM.
- The runtime enforces a process-local 1,400 RPD budget from `GEMINI_RPD`.
